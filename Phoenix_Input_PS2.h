//====================================================================
//Hardware setup: Playstation 2 remote
//
//Walk method 1:
//- Left StickWalk/Strafett
//- Right StickRotate
//
//Walk method 2:
//- Left StickDisable
...
//- TriangleMove body to 35 mm from the ground (walk pos)and back to the ground
...
#define  MAXPS2ERRORCNT  6     // How many times through the loop will we go before shutting off robot?
